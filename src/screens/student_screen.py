...
def student_screen():
    ...
    if show_registration :
        with st.container(border = True):
            ...
            new_name = st.text_input("Enter your name", placeholder='E.g. Akshaya Yammadi')
            ...
            try:
                audio_data = st.audio_input("Record a short phrase like I a, present, My name is Akshaya.")
            except Exception:
